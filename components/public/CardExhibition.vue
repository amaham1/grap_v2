<template>
  <div class="toss-card overflow-hidden smooth-transition hover:scale-[1.02]">
    <!-- 커버 이미지 -->
    ...
    <div class="p-6">
      <div class="flex justify-between items-start mb-3">
        ...
        <span class="px-3 py-1 text-xs font-medium bg-blue-50 text-blue-700 rounded-full ml-3 whitespace-nowrap">
          {{ item.category_name }}
        </span>
      </div>
