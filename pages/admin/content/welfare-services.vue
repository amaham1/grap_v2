  ...
  <div>
    ...
    <div class="mb-4 p-4 bg-white rounded-lg shadow">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <input type="text" placeholder="서비스명 검색..." class="p-2 border rounded">
      ...
      <table class="min-w-full divide-y divide-gray-200">
        <thead class="bg-gray-50">
          <tr>
            ...
            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">서비스명</th>
        ...
        <tbody class="bg-white divide-y divide-gray-200">
          <!-- 예시 데이터 -->
          <tr>
            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">WELF_001</td>
            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">아이돌봄 서비스</td>
            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">영유아 가정</td>
...
// 여기에 복지 서비스 데이터 로딩 및 관리 로직 추가 예정
</script>
